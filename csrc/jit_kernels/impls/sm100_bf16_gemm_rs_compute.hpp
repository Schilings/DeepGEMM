...
public:
    ...
    static std::string generate_impl(const Args& args) {
        // Kernel template parameters (dual-kernel compute, no comm threads):
...
// ====================================================================
//  Entry point: launch GEMM compute kernel for dual-kernel GEMM+RS
// ====================================================================
static void sm100_bf16_gemm_rs_compute_nt(const torch::Tensor& y,
    ...
    // Total threads = non-epilogue + epilogue (256T, no comm warps)
