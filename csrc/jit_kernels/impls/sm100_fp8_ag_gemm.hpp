...
class SM100FP8AGGemmRuntime final : public LaunchRuntime<SM100FP8AGGemmRuntime> {
public:
    struct Args {
        int max_m_per_rank;
...
static void __instantiate_kernel() {{
    auto ptr = reinterpret_cast<void*>(&sm100_fp8_ag_gemm_nt_impl<
        {}, {}, {},
        {},
        {}, {}, {},
        {}, {},
...
static void sm100_fp8_ag_gemm_nt(const torch::Tensor& d,
                                 const torch::Tensor& slots_x,
                                 const torch::Tensor& slots_x_sf,
    ...
    const auto config = get_ag_gemm_config(runtime_m_per_rank * num_ranks, n, k, num_sms);
    ...
    const auto tensor_map_sfa = make_tma_sf_desc(cute::UMMA::Major::MN, slots_x_sf,
                                                 max_m_per_rank, k,
    ...
    const SM100FP8AGGemmRuntime::Args args = {
    ...
    const auto code = SM100FP8AGGemmRuntime::generate(args);
    const auto runtime = compiler->build("sm100_fp8_ag_gemm_nt", code);
    SM100FP8AGGemmRuntime::launch(runtime, args);
}
