...
**环境**: B300 ×8, Wan2.1 T2V-14B (40层, 14.056B 参数, 官方权重), SerialUlysses, **FSDP2 (fully_shard)**, **THD Packed (SP=1 varlen)**

| 场景 | Tokens | Static SP=8 (tok/s) | Dynamic SP×DP (tok/s) | 加速比 |
|------|-------:|---:|---:|---:|
| all_short_2K×8 | 16,384 | 5,902 | 40,414 | **6.848x** |
| uniform_8K×8 | 65,536 | 22,161 | 46,832 | **2.113x** |
| bimodal (2×32K+6×2K) | 77,824 | 20,072 | 36,968 | **1.842x** |
| one_long_tail (1×32K+7×2K) | 47,104 | 14,162 | 22,372 | **1.580x** |
| uniform_32K×2 | 65,536 | 35,857 | 38,596 | **1.076x** |
| mixed (varied) | 77,824 | 22,084 | 19,374 | 0.877x |

**几何平均: 1.847x** (6 个场景中 5 个加速)
